...
* Hardware Availability: 3D Print of the macropad case: [VOID9 Macropad by V0ID](https://www.thingiverse.com/thing:3582237)

Make example for this keyboard (after setting up your build environment):

    make handwired/mingwahlu/ming9macro:default

Flashing example for this keyboard:

    make handwired/mingwahlu/ming9macro:default:flash
